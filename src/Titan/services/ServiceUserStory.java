...
public class ServiceUserStory {
    ...
    public static ServiceUserStory getInstance() {
     ...
     //   String url = Statics.BASE_URL+"/tasks/";
        String url = Statics.BASE_URL +"afficheeUser/" +idf ;
      ...
      public boolean addUserStory(UserStory us) {
        String url = Statics.BASE_URL +"addUserStory/" + us.getUser_story_description()+ "/" + us.getTotal_estimation_userstory_jours()+ "/" + us.getPriority()+ "/" + us.getId_feature();
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
       ...
       public boolean UpdateProgressUserStory(int idus , int newValue ) {
        String url = Statics.BASE_URL +"upUserStory/" + idus+ "/" +  newValue;
        req.setUrl(url);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override
            public void actionPerformed(NetworkEvent evt) {
